    ...
    private void addRideOption(String name, String description, String availability) {
        ...
        rideView.setOnClickListener(v -> {
            if(availability.equals("Available")) {
                ...
                intent.putExtra("pickupLatitude", getIntent().getDoubleExtra("pickupLatitude", 0.0));
                intent.putExtra("pickupLongitude", getIntent().getDoubleExtra("pickupLongitude", 0.0));
